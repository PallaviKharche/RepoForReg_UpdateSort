...
angular.module('bahmni.registration')
    .controller('SearchPatientController', ['$rootScope', '$scope', '$location', '$window', 'spinner', 'patientService', 'appService',
        ...
        function ($rootScope, $scope, $location, $window, spinner, patientService, appService, messagingService, $translate, $filter) {
            ...
            $scope.sortPatient = function (data1) {
                if("ID"===data1)
                    {
                ...
                {
                    $scope.results = naturalOrderBy.orderBy($scope.results, [function (obj) {
                        return obj.customAttribute.US_REG_DATE;
                     }],direction);
                ...
                {
                    $scope.results = naturalOrderBy.orderBy($scope.results, [function (obj) {
                        if(obj.customAttribute.PATIENT_STATUS == "Pre TARV"){
                            return obj.customAttribute.PATIENT_STATUS;
                        }
                        else{
                            return obj.customAttribute.PATIENT_STATUS;
                        }
                ...
                {
                    $scope.results = naturalOrderBy.orderBy($scope.results, [function (obj) {
                        return obj.customAttribute.PRIMARY_CONTACT_NUMBER_1;
                     }],direction);
                ...
                {
                    $scope.results = naturalOrderBy.orderBy($scope.results, [function (obj) {
                        return obj.customAttribute.NICK_NAME;
                     }],direction);
